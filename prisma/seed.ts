    ...
    data: [
      {
        templateId: template.id,
        name: "S",
        description: "Chest: 38 in, Length: 27 in",
        sortOrder: 1,
      },
      {
        templateId: template.id,
        name: "M",
        description: "Chest: 40 in, Length: 28 in",
        sortOrder: 2,
      },
      {
        templateId: template.id,
        name: "L",
        description: "Chest: 42 in, Length: 29 in",
        sortOrder: 3,
      },
      {
        templateId: template.id,
        name: "XL",
        description: "Chest: 44 in, Length: 30 in",
        sortOrder: 4,
      },
    ],
    skipDuplicates: true,
